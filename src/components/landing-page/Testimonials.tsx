  ...
  return (
    <figure
      className={cn(
        ...
        // light styles
        "border-primary/[0.15] bg-muted/70 hover:bg-muted/80"
      )}
    >
...
const Testimonials = () => {
  return (
    <section className="w-full container px-6 xs:px-8 sm:px-0 sm:mx-8 lg:mx-auto py-32 flex flex-col items-center justify-center overflow-hidden">
