  ...
  const handleFormSubmit = async (data: HanziFormValues) => {
    ...
    try {
      ...
      const submissionData = {
        // Standard character: simplified form for traditional, otherwise main character
        standard_character:
          data.character_type === "traditional"
            ? data.related_character!
            : data.character,

        // Traditional character: main character for traditional/identical, related for simplified
        traditional_character:
          data.character_type === "simplified"
            ? data.related_character!
            : data.character,
        ...
        // Radical IDs - same logical structure
        standard_radical_ids:
          data.character_type === "traditional"
            ? data.related_radical_ids!
            : data.radical_ids,
